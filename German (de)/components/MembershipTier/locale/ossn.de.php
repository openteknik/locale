...
ossn_register_languages('de', array(
	...
	'membershiptier:gadgets:available'             => 'Verfügbare Module',
	'membershiptier:disallowed'                    => 'Nicht erlaubte Aktionen',
	'membershiptier:subtext'                       => 'Ein Mitglied mit dieser Stufe kann nur die erlaubten Aktionen ausführen. Bitte entsprechend einstellen.',
	'membershiptier:settings'                      => 'Mitgliedschaftsstufen verwalten',

	'membershiptier:gadget:action:group:add'       => 'Aktion | Gruppe hinzufügen',
	...
	'membershiptier:gadget:action:friend:add'      => 'Aktion | Freund hinzufügen',
	...
	'membershiptier:gadget:page:video:add'         => 'Seite | Video hinzufügen',
	'membershiptier:gadget:page:video:all'         => 'Seite | Videoliste',
	'membershiptier:gadget:page:event:add'         => 'Seite | Veranstaltung hinzufügen',
	'membershiptier:gadget:page:poll:add'          => 'Seite | Umfrage hinzufügen',
	'membershiptier:gadget:page:poll:all'          => 'Seite | Umfrageliste',
	'membershiptier:gadget:page:files:add'         => 'Seite | Datei hinzufügen',
	'membershiptier:gadget:page:files:all'         => 'Seite | Dateiliste',
	'membershiptier:gadget:page:marketplace:add'   => 'Seite | Produkt auf Marktplatz hinzufügen',
	'membershiptier:gadget:page:marketplace:list'  => 'Seite | Marktplatzliste',
	'membershiptier:gadget:page:mp3:add'           => 'Seite | Audio hinzufügen',
	...
	'membershiptier:text'                          => 'Sie können im nächsten Schritt die erlaubten Aktionen für jede Stufe auswählen.',
	...
	'membershiptier:tieradd:failed'                => 'Hinzufügen der Stufe fehlgeschlagen. Bitte alle Felder ausfüllen.',
	'membershiptier:manageaccess'                  => 'Zugriffsrechte verwalten',
	'membershiptier:edit'                          => 'Stufe bearbeiten',
	'membershiptier:delete'                        => 'Löschen',
	...
	'membershiptier:add'                           => 'Stufe hinzufügen',
	'membershiptier:members:count'                => 'Mitglieder verwenden',
	'membershiptier:configure'                     => 'Konfigurieren',
	'membershiptier:cron:text'                     => 'Sie müssen CRON-Jobs konfigurieren, damit Ihre Mitgliedschaftsstufe funktioniert.',

	'membershiptier:type:page'                     => 'Seite',
	'membershiptier:type:action'                   => 'Aktion',
	'membershiptier:deleted'                       => 'Stufe wurde gelöscht!',
	'membershiptier:delete:failed'                 => 'Löschen der Stufe fehlgeschlagen',
	...
	'tier:subscribe:failed'                        => 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es später erneut oder wenden Sie sich an den Administrator!',
	'membershiptier:pricing:heading'               => 'Um eine reibungslose Nutzung zu gewährleisten, stellen Sie bitte sicher, dass ausreichend Guthaben in Ihrem Wallet vorhanden ist. Optional können Sie eine Zahlungskarte hinterlegen, damit automatische Zahlungen reibungslos funktionieren.',

	'membershiptier:add:funds'                     => 'Guthaben hinzufügen',
	'membershiptier:status'                        => 'Mitgliedschaftsdetails',
	'membership:terminate:warning'                 => 'Diese Aktion ist unwiderruflich. Möchten Sie wirklich kündigen?',
	'membership:status'                            => 'Mitgliedschaftsstatus',
	'membership:status:subtext'                    => 'Willkommen auf Ihrer Mitgliedschaftsübersichtsseite. Hier finden Sie alle relevanten Informationen zu Ihrer Mitgliedschaft.',

	'membership:status:plan'                       => 'Planname',
	'membershiptier:duedate'                       => 'Fälligkeitsdatum',
	'membershiptier:canceltext'                    => 'Wir verstehen, dass sich Umstände ändern können. Die Kündigung Ihrer Mitgliedschaft ist einfach und es fallen keine Gebühren an. Ihr Zugang zu bezahlten Funktionen wird beendet.',

	'membershiptier:cancel:now'                    => 'Jetzt kündigen',
	'membershiptier:nostatus'                      => '<p>Wir haben derzeit keine aktiven Abonnements für Ihr Konto.</p>

<p><strong>Abonnement abgelaufen:</strong> Ihr vorheriges Abonnement ist abgelaufen und wurde nicht erneuert. Bitte erneuern Sie es, um weiterhin unsere Dienste nutzen zu können.</p>

<p><strong>Abonnement gekündigt:</strong> Falls Sie ein aktives Abonnement hatten, das Sie gekündigt haben, werden die Details nicht mehr angezeigt. Sie können sich jedoch jederzeit erneut anmelden.</p>

<p><strong>Neues Konto oder keine Historie:</strong> Wenn Sie neu sind, haben Sie möglicherweise noch keinen Plan abonniert. Diese Seite bleibt leer, bis Sie ein Abonnement starten.</p>',

	'membershiptier:plans'                          => 'Pläne ansehen',
	'membershiptier:needs:sub'                      => 'Sie müssen sich für diesen Plan anmelden, um die Seite zu sehen!',
	'membershiptier:success:charge:cron'            => 'Mitgliedschaft erfolgreich erneuert!',
	'membershiptier:success:charge:cron:msg'        => "Lieber %s,


Herzlichen Glückwunsch! Ihre Mitgliedschaft wurde erfolgreich erneuert. Sie können weiterhin alle Vorteile nutzen, ohne Unterbrechung.
...
Ihre Mitgliedschaft konnte nicht erneuert werden. Überprüfen Sie Ihre Zahlungsdaten und Ihr Wallet-Guthaben. Bei Problemen wenden Sie sich bitte an den Support.

Danke!",
	'membershiptier:current:date'                   => 'Systemdatum & -zeit',
	'membershiptier:expiry:never'                  => 'Nie',
	'membershiptier:delete:text'                   => 'Wenn Sie diese Stufe löschen, verlieren alle Benutzer dieser Stufe ihre Mitgliedschaft.',
	...
	'membershiptier:force:cards:p'                 => 'Wenn aktiviert, müssen Benutzer beim Abonnement eine Karte hinterlegen. Andernfalls können sie später eine Karte speichern oder manuell Guthaben hinzufügen.',
	'membershiptier:force:disabled'                => 'Deaktiviert',
	'membershiptier:force:enabled'                 => 'Aktiviert',
	'membershiptier:addusertotier'                 => 'Benutzer zur Stufe hinzufügen',
	'membershiptier:attachuser:note'               => 'Sie können einem Benutzer manuell eine Stufe zuweisen, nachdem Sie Guthaben auf sein Wallet geladen haben.',
	...
	'membershiptier:searchuser:noadmin'            => 'Admins können nicht zu einer Stufe hinzugefügt werden!',
	'membershiptier:searchuser:already'            => 'Dieser Benutzer hat bereits eine aktive Stufe.',
	'tier:manualattach:failed'                     => 'Benutzer konnte nicht zur Stufe hinzugefügt werden!',
