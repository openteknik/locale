...
ossn_register_languages('it', array(
	 'vidconverse' => 'Videochiamate', 
	 'vidconverse:recipient:subject' => '%s ti ha inviato una richiesta di videochiamata', 
	 'vidconverse:recipient:message' => 'Caro %s,
...
[%S]', 
	 ...
	 'vidconverse:request:message' => 'Hai inviato una richiesta di videochiamata', 
	 'vidconverse:request:message:received:text' => 'Hai ricevuto una richiesta di videochiamata. Puoi accettare o ignorare', 
	 'vidconverse:accept' => 'Accettare', 
	 'vidconverse:call:error' => 'La richiesta di chiamata non può essere inviata', 
	 'vidconverse:apikey' => 'Inserisci la chiave API ottenuta da https://www.openteknik.com/videocalling/requestss', 
